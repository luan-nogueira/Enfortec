    ...
    items: [
      {
        ...
        a: "Aceitamos Pix, Cartão de Crédito (parcelado em até 12x), Boleto Bancário e Saldo Mercado Pago. Todos os pagamentos são processados com segurança via Mercado Pago."
      },
      {
        q: "É seguro comprar aqui?",
        a: "Sim! Utilizamos criptografia SSL e a avançada proteção contra fraudes do Mercado Pago. Sua compra tem garantia total — se não receber o produto, você é reembolsado."
      },
      {
